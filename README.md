...
I have included start orbs in "files\orbs". Select the theme's start menu and an orb in the StartIsBack++ configuration and click apply. If it's not an option to choose the theme's start menu, later on you can check once your custom theme is applied. The "files\orbs_downsized" directory contains start orbs modified by me to work properly with the "Use small taskbar buttons" setting set to on.
